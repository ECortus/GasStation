...
namespace DavidJalbert
{
    ...
    public class TinyCarController : MonoBehaviour
    {
        ...
        /* [SerializeField] private CarController mainController; */
        /* [SerializeField] private UniversalCarController secondController; */
        ...
        private bool TakeControl
        {
            get
            {
                ...
                {
                    return /* mainController.takeControl */ false;
                }
                /* else
                {
                    return secondController.takeControl;
                } */
            }
        }
        ...
        virtual protected void FixedUpdate()
        {
            ...
            float groundXAngle = 0f;
            float groundZAngle = 0f;
